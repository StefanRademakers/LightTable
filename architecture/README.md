...
11. [Product UX inspiration and capability gaps](PRODUCT_UX_INSPIRATION_AND_GAPS.md)
12. [Input, tools and history](INPUT_TOOLS_AND_HISTORY.md)
13. [UI, workspace and design system](UI_WORKSPACE_AND_DESIGN_SYSTEM.md)
14. [Reliability and verification](RELIABILITY_AND_VERIFICATION.md)
15. [Current state and roadmap](CURRENT_STATE_AND_ROADMAP.md)
16. [Change rules](CHANGE_RULES.md)
