...
10. [Product UX inspiration and capability gaps](PRODUCT_UX_INSPIRATION_AND_GAPS.md)
11. [Input, tools and history](INPUT_TOOLS_AND_HISTORY.md)
12. [UI, workspace and design system](UI_WORKSPACE_AND_DESIGN_SYSTEM.md)
13. [Reliability and verification](RELIABILITY_AND_VERIFICATION.md)
14. [Current state and roadmap](CURRENT_STATE_AND_ROADMAP.md)
15. [Change rules](CHANGE_RULES.md)
