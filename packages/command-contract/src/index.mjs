...
import adjustmentStructureCommandSchemas from '../schemas/v1/adjustment-structure.json' with { type: 'json' };
...
const baseCommandSchemas = Object.freeze({
  ...
  ...schemaModuleCommands(adjustmentStructureCommandSchemas),
