...
export interface GradientFieldProps extends Omit<PaintFieldProps, 'kind' | 'value' | 'onSample' | 'sampling' | 'size'> {
  value: GradientFieldValue;
  size?: 'compact';
}

export const GradientField = React.forwardRef<HTMLButtonElement, GradientFieldProps>(function GradientField({ value, ...props }, ref) {
  return <PaintField ref={ref} {...props} kind="gradient" value={gradientFieldBackground(value)} />;
});
