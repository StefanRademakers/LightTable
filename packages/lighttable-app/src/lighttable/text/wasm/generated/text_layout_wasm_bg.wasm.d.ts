...
export const __wbg_packedglyphoutline_free: (a: number, b: number) => void;
export const drop_layout_session: (a: number, b: number) => number;
export const extract_registered_glyph_outline: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => [number, number, number];
...
export const packedglyphoutline_bounds: (a: number) => [number, number];
export const packedglyphoutline_coordinates: (a: number) => [number, number];
export const packedglyphoutline_units_per_em: (a: number) => number;
export const packedglyphoutline_verbs: (a: number) => [number, number];
...
export const realize_flow_text: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number, q: number, r: number, s: number, t: number, u: number, v: number, w: number, x: number, y: number, z: number) => [number, number, number];
