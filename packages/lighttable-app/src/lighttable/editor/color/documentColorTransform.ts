...
export const documentBlendProfileDisplayName = (profile: DocumentBlendProfile) =>
  profile === 'adobe-rgb-1998' ? 'Adobe RGB (1998) compatible' : 'sRGB';

export const documentBlendProfileDescription = (profile: DocumentBlendProfile) =>
  profile === 'adobe-rgb-1998'
    ? 'Compatible with the Adobe RGB (1998) ICC profile'
    : 'Standard sRGB blend behavior';
...
export const documentBlendQuantization = (bitDepth: 8 | 16 | 32) =>
  bitDepth === 8 ? 255 : bitDepth === 16 ? 32_768 : 0;
