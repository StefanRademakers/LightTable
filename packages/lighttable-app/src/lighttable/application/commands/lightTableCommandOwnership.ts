...
const MOUNTED_DOCUMENT_COMMAND_PORTS = {
  ...
  'layer.setOpacity': 'executeLayerCommand',
  'layer.setVectorAntiAlias': 'executeLayerCommand',
  'layer.reorder': 'executeLayerCommand',
  'layer.createGradientFill': 'executeLayerCommand',
  'layer.createGroup': 'executeLayerCommand',
  'layer.group': 'executeLayerCommand',
  'layer.ungroup': 'executeLayerCommand',
  ...
  'adjustment.modifyStructure': 'executeProcessingStructure',
