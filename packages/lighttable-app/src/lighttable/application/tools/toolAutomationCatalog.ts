...
export const TOOL_AUTOMATION_CATALOG = {
  ...
  gradient: uiCommand('continuous', ['vector.create', 'vector.update'],
    'Gradient Fill drags publish once after native commit; raster pixel gradients remain on their GPU owner and are not exposed.'),
