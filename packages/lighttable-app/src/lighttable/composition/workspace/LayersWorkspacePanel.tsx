  ...
  return (
    <div className="lighttable-layers-panel">
      <LayerPanel
        ...
        onSoloVisibility={controller.toggleSoloVisibility}
        onOtherLayersVisibility={controller.setOtherLayersVisibility}
        onAllLayersVisibility={controller.setAllLayersVisibility}
        onVisibilityInteractionStart={controller.beginVisibilityInteraction}
        onVisibilityPreview={controller.previewVisibility}
        onVisibilityInteractionEnd={controller.endVisibilityInteraction}
        onVisibilityInteractionCancel={controller.cancelVisibilityInteraction}
        ...
        onOpacityInteractionCancel={controller.cancelOpacityInteraction}
        ...
        onRasterizeLayer={controller.rasterizeActive}
